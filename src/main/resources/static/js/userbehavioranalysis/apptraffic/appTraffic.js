...
apptrafficInitJs = {
    ...
    initTable:function () {
        $('#table').bootstrapTable('destroy').bootstrapTable({
            method: 'post',
            url: '/userbehavioranalysis/apptraffic/listData',
    ...
    initTable3:function () {
        ...
        $('#appIdDetailTable').bootstrapTable('destroy').bootstrapTable({
            method: 'post',
            url: '/userbehavioranalysis/apptraffic/listDefinedAppIdData',
    ...
    initBar:function () {
        ...
        $.ajax({
            url: '/userbehavioranalysis/apptraffic/getEChartsData',
            ...
            success: function (data) {
                ...
                if (data!=""){
                    ...
                    if (statType==1){
                     ...
                     //   seriesObjArray[0].itemStyle.color=["#eb547c"]
                 ...
                 //       seriesObjArray[1].itemStyle.color = ["#2ec7c9"];
    ...
    initBar2:function () {
        ...
        $.ajax({
            url: '/userbehavioranalysis/apptraffic/getSecondEChartsData',
            data: JSON.stringify(data),
            type: 'POST',
            async: false,
            contentType: "application/json",
    ...
    initLine:function () {
        ...
        $.ajax({
            url: '/userbehavioranalysis/apptraffic/getLineData',
            ...
            success: function (data) {
                ...
                if (data!=""){
                    ...
                    if (paramData.statType==1||paramData.statType==4){
                       ...
                       /* if(paramData.statType==1){
                            apptrafficInitJs.option2.yAxis=[
                                {
                                    type: 'value',
                                    axisLabel: {
                                        formatter: '{value} ' + data.unit
    ...
    initClick : function () {
        ...
        $('#exportButton111').find('li').click(function () {
            ...
            form += '<input name="probeType" value="0" />';
            ...
            form += '</form>';
            $('body').append(form);
            $('#export1').attr('action', '/userbehavioranalysis/apptraffic/exportData.do?ran='+Math.random()).attr('method', 'post').submit();
        ...
        $('#exportButton222').find('li').click(function () {
            ...
            form += '</form>';
            $('body').append(form);
            $('#export2').attr('action', '/userbehavioranalysis/apptraffic/exportData.do?ran='+Math.random()).attr('method', 'post').submit();
            $('#export2').remove();
        });
        ...
        $('#exportButton333').find('li').click(function () {
            ...
            form += '</form>';
            $('body').append(form);
            $('#export3').attr('action', '/userbehavioranalysis/apptraffic/exportData.do?ran='+Math.random()).attr('method', 'post').submit();
            $('#export3').remove();
        });
...
function getColumn() {
    var column =[
        ...
        {field: 'appTrafficUpStr',sortable:true,title: '<span title="上行流量">上行流量</span>',formatter:function(value,row,index){
            return "<span title='"+value+"'>"+value+"</span>";
        }},
        {field: 'appTrafficDnStr',sortable:true,title: '<span title="下行流量">下行流量</span>',formatter:function(value,row,index){
            return "<span title='"+value+"'>"+value+"</span>";
        }},
...
function getColumn2() {
    var column =[
        ...
        {field: 'appTrafficUp',sortable:true,title: '<span title="上行流量">上行流量</span>',formatter:function(value,row,index){
            return "<span title='"+value+"'>"+row.appTrafficUpStr+"</span>";
        }},
        {field: 'appTrafficDn',sortable:true,title: '<span title="下行流量">下行流量</span>',formatter:function(value,row,index){
            return "<span title='"+value+"'>"+row.appTrafficDnStr+"</span>";
        }},
        {field: 'appTrafficSum',sortable:true,title: '<span title="总流量">总流量</span>',formatter:function(value,row,index){
            return "<span title='"+value+"'>"+row.appTrafficSumStr+"</span>";
        }},
        {field: 'appUserNum',sortable:true,title: '<span title="用户数">用户数</span>',formatter:function(value,row,index){
            return "<span title='"+value+"'>"+value+"</span>";
        }},
...
function getColumn3() {
    var column =[
        ...
        {field: 'appTrafficUp',sortable:true,title: '<span title="上行流量">上行流量</span>',formatter:function(value,row,index){
            return "<span title='"+row.appTrafficUpStr+"'>"+row.appTrafficUpStr+"</span>";
        }},
        {field: 'appTrafficDn',sortable:true,title: '<span title="下行流量">下行流量</span>',formatter:function(value,row,index){
