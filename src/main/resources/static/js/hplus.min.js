...
layer.config({
	...
	$(".side-menu").metisMenu(), $(".right-sidebar-toggle").click(function() {
		...
		if($("#wrapper>.nav-header").hasClass("active")){
			$("#wrapper>.nav-header").removeClass("active");
		}else{
			$("#wrapper>.nav-header").addClass("active");
		}
		...
		$(".side-menu>li").find("i").removeClass("fa-folder-open").addClass("fa-folder");
