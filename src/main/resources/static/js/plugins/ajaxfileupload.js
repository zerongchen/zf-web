...
jQuery.extend( {
	 createUploadIframe: function(id, uri)  
		...
		createUploadForm : function(id, fileElementId, data) {
			...
			var html = "<span><input name=\"batchFile\" type=\"file\" class=\"w300\" accept=\"text/plain\"/></span>";
			$(html).appendTo($("#addTaskDiv .file"));
			// set attributes
			...
			var uploadCallback = function(isTimeout) {
				...
				try {
					if (io.contentWindow) {
						...
						xml.responseText = io.contentDocument.document.body ? io.contentDocument.document.body.innerText
								: null;
